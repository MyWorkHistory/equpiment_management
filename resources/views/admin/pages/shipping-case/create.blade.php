        ...
        <div class="card radius-15">
            <div class="card-body">
                <div class="card-title">
                    <h4 class="mb-0">Add Shipping Case</h4>
                </div>
                <hr/>
               
                <form method="POST" action="{{ route('admin.shipping-cases.store') }}">
                    @csrf
                    @if ($errors->any())  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('manufacture') is-invalid @enderror"
                                     name="manufacture" value="{{ old('manufacture') }}" placeholder="Please input manufacture" autofocus>
                            </div>
                        </div>   
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('model_number') is-invalid @enderror"
                                     name="model_number" value="{{ old('model_number') }}" placeholder="Please input model number">
                            </div>
                        </div> 
